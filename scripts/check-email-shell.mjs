...
const A_MIGRER = {
  'supabase/functions/_shared/agency-verification-notice.ts':
    "Avis de décision KYB au dirigeant (validé / refusé / correction demandée). CLIENT, à migrer en priorité : c'est le premier e-mail que reçoit une agence après sa soumission.",
