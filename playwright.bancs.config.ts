...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: ['**/menus-clic-droit.spec.ts', '**/menu-compte.spec.ts', '**/onglet-neuf.spec.ts', '**/cloche.spec.ts', '**/journal-audit.spec.ts', '**/calendrier-deplacement.spec.ts', '**/messagerie-logos.spec.ts', '**/messagerie-cadre.spec.ts', '**/messagerie-destinataires.spec.ts', '**/messagerie-deconnexion.spec.ts', '**/messagerie-ajout-boite.spec.ts', '**/messagerie-gestes.spec.ts', '**/messagerie-liste.spec.ts', '**/messagerie-spam.spec.ts'],
  fullyParallel: true,
