...
- **`CalendarOnboarding` supprimée** (−162 lignes, + asset `public/calendar/calendar-glass.svg`, + 6 clés i18n ×4 langues). `CalendarSugarV2Page` monte désormais `CalendarApp` **sans condition**.
