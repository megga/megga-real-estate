// MEGGA CRM — Dashboard — Données mockées pour la Session de relance
// 47 leads dormants + brouillons IA pré-rédigés + variantes de ton.
// Cette base sert à crédibiliser le sentiment "MEGGA AI a vraiment réfléchi pour chaque lead".

// ─── 47 leads dormants ────────────────────────────────────────────────
// Chaque lead a un contexte riche : bien suivi, historique, ce qu'il a dit,
// budget, KYC, score, raison de la dormance.

const RELANCE_LEADS = [
  {
    id: "lead-01", first: "Sophie", last: "Aebischer",
    avatarBg: "#3B82F6", score: 84,
    bien: "Villa Pully · Ch. des Crêts 12", bienPrice: "1'450'000",
    budget: "1.4M",
    kyc: "verified",
    dormSince: 18,
    reason: "A visité 2x, KYC validé. N'a plus donné signe après ta dernière relance du 22 avril.",
    quote: "« J'hésite entre la Villa Pully et un appartement à Lutry — laissez-moi le week-end. »",
    history: [
    ...
    nextStepHint: "Couple décisionnaire, signaux d'achat clairs lors de la 2e visite.",
  },
  {
    id: "lead-02", first: "Marc", last: "Devaud",
    avatarBg: "#10B981", score: 76,
    bien: "Appartement Av. de la Gare 14", bienPrice: "780'000",
    budget: "800K",
    kyc: "pending",
    dormSince: 16,
    reason: "A demandé la fiche en ligne mais n'a jamais confirmé de visite. KYC en attente.",
    ...
    nextStepHint: "Probable freezing par incertitude bancaire. Proposer un RDV banque commun.",
  },
  {
    id: "lead-03", first: "Léa", last: "Rochat",
    avatarBg: "#F59E0B", score: 91,
    bien: "Loft Ouchy Marquisat", bienPrice: "1'120'000",
    budget: "1.2M cash",
    kyc: "verified",
    dormSince: 14,
    reason: "Lead extrêmement chaud. KYC parfait, cash disponible. Inactive depuis sa visite seule.",
    ...
    nextStepHint: "Tu es probablement à 48-72h d'une offre. Ne pas presser, juste ré-ouvrir la conversation.",
  },
  {
    id: "lead-04", first: "Pierre", last: "Müller",
    avatarBg: "#8B5CF6", score: 62,
    bien: "Maison Lutry · Rte du Lac", bienPrice: "1'890'000",
    budget: "1.5M (au-dessus du budget)",
    kyc: "none",
    dormSince: 22,
    reason: "Visite enthousiaste mais budget de 400K en dessous du prix demandé.",
    ...
    nextStepHint: "Ne pas insister sur Lutry. Lui matcher 3 biens dans son budget réel.",
  },
  {
    id: "lead-05", first: "Camille", last: "Schneider",
    avatarBg: "#EF4444", score: 79,
    bien: "Studio Flon · Rue Centrale", bienPrice: "395'000",
    budget: "400K",
    kyc: "verified",
    dormSince: 19,
    reason: "Premier achat, KYC validé. A visité 3 studios différents sans se décider.",
    ...
    nextStepHint: "A besoin de réassurance, pas de plus d'options. Proposer un rdv conseil 30 min.",
  },
  {
    id: "lead-06", first: "Thomas", last: "Favre",
    avatarBg: "#06B6D4", score: 71,
    bien: "Duplex Cité · Rue Centrale 8", bienPrice: "920'000",
    budget: "1M",
    kyc: "verified",
    dormSince: 17,
    reason: "A visité et aimé. Voulait revenir avec sa compagne, jamais reprogrammé.",
    ...
    nextStepHint: "Proposer 3 créneaux concrets (soir / week-end) pour faciliter la coordination.",
  },
  {
    id: "lead-07", first: "Aïcha", last: "Dupont",
    avatarBg: "#EC4899", score: 88,
    bien: "Villa St-Sulpice · Rte du Lac", bienPrice: "2'350'000",
    budget: "2.5M",
    kyc: "verified",
    dormSince: 21,
    reason: "Couple de médecins, 2.5M budget, visite excellente. Silence depuis 3 semaines.",
    quote: "« Notre fille rentre en école Pully en septembre, on doit décider vite. »",
    history: [
    ...
    nextStepHint: "L'urgence scolaire est ton meilleur allié. Subtilement la rappeler.",
  },
  {
    id: "lead-08", first: "Olivier", last: "Maillard",
    avatarBg: "#84CC16", score: 65,
    bien: "Penthouse Beau-Rivage", bienPrice: "3'200'000",
    budget: "non confirmé",
    kyc: "none",
    dormSince: 25,
    ...
    nextStepHint: "Ne pas accorder de visite sans KYC + preuve de fonds. Polite mais ferme.",
  },
];

// On complète à 47 leads avec des contextes plus génériques mais plausibles
const _FILLER_FIRSTS = ["Nadia","Lucas","Marie","Antoine","Élodie","Julien","Sarah","Hugo","Inès","Vincent","Clara","François","Émilie","Romain","Laure","Bastien","Alice","Damien","Chloé","Florian","Manon","Quentin","Pauline","Adrien","Lise","Mathieu","Anouk","Cyril","Hélène","Nicolas","Justine","Sébastien","Karine","Théo","Solène","Yann","Audrey","Maxime","Anaïs"];
const _FILLER_LASTS = ["Henchoz","Bochud","Pasche","Romanens","Curty","Cottet","Vauthey","Charrière","Genoud","Risse","Mooser","Yerly","Buchs","Schornoz","Pillonel","Pochon","Demierre","Volery","Brodard","Lambert","Magnin","Ottoz","Bersier","Crausaz","Dafflon","Riedo","Schaller","Tinguely","Werro","Zosso","Andrey","Bapst","Chassot","Délitroz","Egger","Fasel","Galley","Hayoz","Imhof"];
const _FILLER_BIENS = [
...
const _AVATAR_BGS = ["#3B82F6","#10B981","#F59E0B","#8B5CF6","#EF4444","#06B6D4","#EC4899","#84CC16"];
const _DORM_REASONS = [
...
for (let i = 0; i < 39; i++) {
  const f = _FILLER_FIRSTS[i % _FILLER_FIRSTS.length];
  const l = _FILLER_LASTS[i % _FILLER_LASTS.length];
  const b = _FILLER_BIENS[i % _FILLER_BIENS.length];
  const r = _DORM_REASONS[i % _DORM_REASONS.length];
  RELANCE_LEADS.push({
    id: `lead-${String(9 + i).padStart(2, "0")}`,
    first: f, last: l,
    avatarBg: _AVATAR_BGS[i % _AVATAR_BGS.length],
    score: 50 + ((i * 7) % 40),
    bien: b.n, bienPrice: b.p,
    budget: ["650K","850K","1M","1.2M","1.5M","2M"][i % 6],
    kyc: ["verified","pending","none"][i % 3],
    dormSince: 14 + (i % 30),
    reason: r.r,
    quote: r.q,
    history: [
    ...
    nextStepHint: "Lead avec signaux modérés. Une relance personnalisée peut le réveiller.",
  });
}

// ─── Brouillons MEGGA AI par lead ─────────────────────────────────────
// Chaque lead a un brouillon UNIQUE généré sur la base de son contexte.
const DRAFT_TEMPLATES = {
  // Sophie — couple décisionnaire, 2 visites Villa Pully
  "lead-01": {
  ...
  // Léa — quasi-offre, ne pas presser
  "lead-03": {
  ...
  // Pierre — budget trop haut, bascule
  "lead-04": {
  ...
  // Camille — premier achat, rassurance
  "lead-05": {
...
// Brouillon générique pour les leads "filler"
function _genericDraft(lead) {
  return {
...
function getInitialDraft(lead) {
  return DRAFT_TEMPLATES[lead.id] || _genericDraft(lead);
}

// ─── Variantes de ton MEGGA AI ────────────────────────────────────────
// Chaque tonalité fournit une transformation déterministe pour la démo.
// (En prod : appel à un LLM avec un system prompt par ton.)

const TONE_VARIANTS = {
  // Plus formel : tu → vous (déjà vous par défaut), suppression contractions
  ...
  // Plus chaleureux : ton personnel, on revient à tu/prénom seul
  chaleureux: (draft, lead) => ({
  ...
  // Plus détaillé : étoffe avec arguments du bien et contexte
  detaille: (draft, lead) => ({
  ...
  // Recréer : nouvelle proposition complète, change angle d'attaque
  recreer: (draft, lead) => ({
...
// Petites étiquettes de l'IA — affichées dans la toolbar
const TONE_ACTIONS = [
...
window.RELANCE_LEADS = RELANCE_LEADS;
window.getInitialDraft = getInitialDraft;
window.TONE_VARIANTS = TONE_VARIANTS;
window.TONE_ACTIONS = TONE_ACTIONS;
