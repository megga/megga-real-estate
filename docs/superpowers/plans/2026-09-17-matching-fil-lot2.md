...
| `supabase/migrations/20260922121000_matching_fil_marche.sql` (créé) | La RPC de résumé |
...
**Files :**
- Create : `supabase/migrations/20260922121000_matching_fil_marche.sql`
- Modify : `src/types/database.ts`

- [ ] **Step 1 : Écrire la migration**

Créer `supabase/migrations/20260922121000_matching_fil_marche.sql` :
...
```bash
git add supabase/migrations/20260922121000_matching_fil_marche.sql src/types/database.ts
...
- **Migration** datée `20260921121000` le jour de l'exécution, renommée `20260922121000` le 22.09.2026 (jour de la fusion, date-guard). Vignettes : `nullif(…, '')`, trois premières NON vides, `created_at desc nulls last`.
