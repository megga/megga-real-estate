...
2. **L'écran est sur une PR, pas sur `main`.** Lot 2 = [PR #1276](https://github.com/megga/megga-real-estate/pull/1276), branche `claude/crm-messagerie-lot2-front` : 137 fichiers, 79 créations, ~26 000 lignes ; 22 composants, 12 hooks, 4 modules purs `src/lib/mail/`, 252 clés i18n, 3 routes.
