// Admin end-users — get_admin_end_user_stats / get_admin_kyc_magic_links
// (migration 20260713140000 ; bloc portails retiré le 2026-07-26 avec la
// fonctionnalité — la table seller_portals et get_admin_seller_portals ont été
// droppées, elles n'avaient jamais porté une seule ligne).
//
//  Test 1 — Gate : un agent simple est rejeté sur les 2 RPC (42501).
//  Test 2 — Stats : le super_admin reçoit la forme jsonb attendue.
//  Test 3 — SÉCURITÉ (non-régression nLPD) : un magic-link seedé apparaît SANS
