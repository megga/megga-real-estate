 ...
 * `send-property-email` (la fiche de bien, et sa clause « la signature vient du profil de
 * l'appelant ») est partie le 21.09.2026 : le matching reste chez l'agent.
 */
const EXPEDITEURS = ['send-email'] as const
