 ...
 * login vit sur la vitrine externe getmegga.com/login, cf. VitrineLoginRedirect dans
...
// getmegga.com/login dès que `user` devient nul), qui ne peut pas aboutir dans cet
