...
export default defineConfig({
  ...
  test: {
    ...
    include: ['tests/unit/**/*.{spec,test}.{ts,tsx}', 'supabase/functions/_shared/whatsapp-gateway.test.ts', 'supabase/functions/_shared/whatsapp-retry.test.ts', 'supabase/functions/_shared/whatsapp-templates.test.ts', 'supabase/functions/_shared/whatsapp-agent-router.test.ts', 'supabase/functions/_shared/whatsapp-media.test.ts', 'supabase/functions/_shared/whatsapp-transcribe.test.ts', 'supabase/functions/_shared/whatsapp-comprehend.test.ts', 'supabase/functions/_shared/whatsapp-lead.test.ts', 'supabase/functions/_shared/vision.test.ts', 'supabase/functions/_shared/whatsapp-format.test.ts', 'supabase/functions/_shared/kyc-extract.test.ts', 'supabase/functions/_shared/kyb-id-read.test.ts', 'supabase/functions/_shared/kyb-identity-stripe.test.ts', 'supabase/functions/_shared/whatsapp-i18n.test.ts', 'supabase/functions/_shared/whatsapp-stop-keywords.test.ts', 'supabase/functions/_shared/whatsapp-outbound-guard.test.ts', 'supabase/functions/_shared/whatsapp-confirm-buttons.test.ts', 'supabase/functions/_shared/whatsapp-phantom-action.test.ts', 'supabase/functions/_shared/whatsapp-actions.test.ts', 'supabase/functions/_shared/whatsapp-optin.test.ts', 'supabase/functions/_shared/whatsapp-optin-send.test.ts', 'supabase/functions/_shared/email-guard.test.ts', 'supabase/functions/_shared/magic-link-token.test.ts', 'supabase/functions/_shared/cf-browser-render.test.ts', 'supabase/functions/_shared/agent-style.test.ts', 'supabase/functions/_shared/rent-reference.test.ts', 'supabase/functions/_shared/megga-prose.test.ts', 'supabase/functions/_shared/morning-brief.test.ts', 'supabase/functions/_shared/copilot-persistence.test.ts', 'supabase/functions/_shared/ai-copilot-request.test.ts', 'supabase/functions/_shared/kyc-screening-core.test.ts', 'supabase/functions/_shared/idx-mapper.test.ts', 'supabase/functions/_shared/whatsapp-followups.test.ts', 'supabase/functions/_shared/whatsapp-followup-draft.test.ts', 'supabase/functions/_shared/whatsapp-token.test.ts', 'supabase/functions/_shared/whatsapp-config.test.ts', 'supabase/functions/_shared/esign-finalize.test.ts', 'supabase/functions/_shared/esign-gateway.test.ts', 'supabase/functions/_shared/copilot-market.test.ts', 'supabase/functions/_shared/copilot-redaction.test.ts', 'supabase/functions/_shared/agent-loop.test.ts', 'supabase/functions/_shared/copilot-tools.test.ts', 'supabase/functions/_shared/knowledge-retrieval.test.ts', 'supabase/functions/_shared/pseudonymize.test.ts', 'supabase/functions/_shared/daily-brief.test.ts', 'supabase/functions/_shared/radar-detectors.test.ts', 'supabase/functions/_shared/weekly-digest.test.ts', 'supabase/functions/_shared/photo-staging.test.ts', 'supabase/functions/_shared/ai-usage.test.ts', 'supabase/functions/_shared/contact-nba.test.ts', 'supabase/functions/_shared/agent-system-prompt.test.ts', 'supabase/functions/_shared/wa-agent-redaction.test.ts', 'supabase/functions/_shared/contact-memory.test.ts', 'supabase/functions/_shared/pii-redaction.test.ts', 'supabase/functions/_shared/audit-edge-error.test.ts', 'supabase/functions/_shared/whatsapp-doc-prompt.test.ts', 'supabase/functions/_shared/npa.test.ts', 'supabase/functions/_shared/ra-slice-resolution.test.ts', 'supabase/functions/_shared/agency-lab-guard.test.ts', 'supabase/functions/_shared/bearer-token.test.ts', 'supabase/functions/_shared/booking-slots.test.ts', 'supabase/functions/_shared/onboarding-slots.test.ts', 'supabase/functions/_shared/google-service-account.test.ts', 'supabase/functions/_shared/client-ip.test.ts', 'supabase/functions/_shared/require-service-secret.test.ts', 'supabase/functions/_shared/admin-alerts.test.ts', 'supabase/functions/_shared/onboarding-email.test.ts', 'supabase/functions/_shared/svix-signature.test.ts', 'supabase/functions/_shared/recipient-language.test.ts', 'supabase/functions/_shared/admin-alert-email.test.ts', 'supabase/functions/_shared/kyb-geocode.test.ts', 'supabase/functions/_shared/emails-quatre-langues.test.ts', 'supabase/functions/_shared/mail/mime.test.ts', 'supabase/functions/_shared/mail/secrets.test.ts', 'supabase/functions/_shared/mail/oauth.test.ts', 'supabase/functions/_shared/mail/gmail.test.ts', 'supabase/functions/_shared/mail/graph.test.ts', 'supabase/functions/_shared/mail/ingest.test.ts', 'supabase/functions/_shared/contact-timeline.test.ts', 'supabase/functions/_shared/email-recipient.test.ts', 'supabase/functions/_shared/safe-fetch.test.ts', 'supabase/functions/_shared/calendar-token-provenance.test.ts', 'supabase/functions/_shared/magic-link-public-view.test.ts', 'supabase/functions/_shared/magic-link-limits.test.ts', 'supabase/functions/_shared/kyc-report-token.test.ts', 'supabase/functions/_shared/mail/disconnect.test.ts', 'supabase/functions/_shared/function-url.test.ts', 'supabase/functions/_shared/stripe-prices.test.ts', 'supabase/functions/_shared/relance-email-send.test.ts', 'supabase/functions/_shared/team-invite-guard.test.ts', 'supabase/functions/_shared/booking-freebusy-cache.test.ts', 'supabase/functions/_shared/mail/logos.test.ts', 'supabase/functions/_shared/mail/imap-client.test.ts', 'supabase/functions/_shared/mail/smtp.test.ts', 'supabase/functions/_shared/mail/mime-parse.test.ts'],
  ...
  resolve: {
    alias: {
      ...
      // Les edges importent `postal-mime` par un spécificateur Deno (`npm:…@version`) que le
      // chargeur de Node ignore : sous vitest, il désigne la devDependency épinglée À
      // L'IDENTIQUE (package.json). Changer l'une sans l'autre ferait tester une autre version.
      'npm:postal-mime@3.0.0': 'postal-mime',
    },
  },
})
