...
export default defineConfig({
  ...
  test: {
    ...
    include: ['tests/unit/**/*.{spec,test}.{ts,tsx}', 'supabase/functions/_shared/whatsapp-gateway.test.ts', 'supabase/functions/_shared/whatsapp-agent-router.test.ts', 'supabase/functions/_shared/whatsapp-media.test.ts', 'supabase/functions/_shared/whatsapp-transcribe.test.ts', 'supabase/functions/_shared/whatsapp-comprehend.test.ts', 'supabase/functions/_shared/whatsapp-lead.test.ts', 'supabase/functions/_shared/vision.test.ts', 'supabase/functions/_shared/whatsapp-format.test.ts', 'supabase/functions/_shared/kyc-extract.test.ts', 'supabase/functions/_shared/whatsapp-i18n.test.ts', 'supabase/functions/_shared/magic-link-token.test.ts', 'supabase/functions/_shared/cf-browser-render.test.ts', 'supabase/functions/_shared/agent-style.test.ts', 'supabase/functions/_shared/rent-reference.test.ts'],
