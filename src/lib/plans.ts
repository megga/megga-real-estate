...
export const PLANS: PlanConfig[] = [
  {
    ...
    features: [
      ...
      { key: 'labs_video', label: 'Vidéos Labs', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'labs_video', label: 'Vidéos Labs', included: true, limit: 10 },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'labs_video', label: 'Vidéos Labs', included: true, limit: 40 },
      { key: 'floor_plan', label: 'Plan interactif', included: true },
      { key: 'calendar_sync', label: 'Sync calendrier', included: true },
