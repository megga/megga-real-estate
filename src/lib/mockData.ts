...
export const MOCK_LISTINGS: MockListing[] = [
  ...
  // ─── ADDITIONAL BUY LISTINGS ───────────────────────────────────────────────
  {
    id: '9',
    title: 'Terrain constructible à Vandoeuvres',
    price: 1800000,
    charges_monthly: 0,
    address: 'Route de Vandoeuvres 88',
    city: 'Vandoeuvres',
    canton: 'GE',
    postal_code: '1253',
    rooms: 0,
    ...
    description: 'Terrain constructible de 1200 m² en zone villa, idéalement situé dans la commune résidentielle de Vandoeuvres. Parcelle plate avec vue dégagée sur le Jura.',
    features: { 'Zone': 'Villa 5', 'Surface': '1200 m²', 'Constructibilité': 'COS 0.25', 'Vue': 'Jura' },
    lat: 46.2120,
    lng: 6.1950,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '10',
    title: 'Local commercial au centre-ville',
    price: 520000,
    charges_monthly: 200,
    ...
    description: 'Local commercial avec vitrine sur la prestigieuse Rue du Rhône. Rez-de-chaussée avec grande vitrine, arrière-boutique et stockage. Idéal pour commerce de détail ou bureau.',
    features: { 'Vitrine': '6 mètres linéaires', 'Hauteur': '3.2 m', 'Accès': 'Plain-pied', 'Climatisation': 'Oui' },
    lat: 46.2015,
    lng: 6.1480,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '11',
    title: 'Appartement vue Salève à Veyrier',
    price: 580000,
    charges_monthly: 290,
    address: 'Chemin de la Sapinière 15',
    city: 'Veyrier',
    canton: 'GE',
    postal_code: '1255',
    rooms: 3,
    ...
    description: 'Bel appartement de 3 pièces avec vue imprenable sur le Salève. Balcon de 10 m², parking souterrain, proche des écoles et commerces. Quartier résidentiel calme.',
    features: { 'Vue': 'Salève', 'Balcon': '10 m²', 'Parking': '1 place souterraine', 'Ascenseur': 'Oui' },
    lat: 46.1720,
    lng: 6.1850,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '12',
    title: 'Villa contemporaine à Meyrin',
    price: 1650000,
    charges_monthly: 0,
    address: 'Chemin des Vignes 22',
    city: 'Meyrin',
    canton: 'GE',
    postal_code: '1217',
    rooms: 6,
    ...
    description: 'Villa contemporaine de standing avec jardin paysager de 500 m² et piscine. Architecture moderne, grandes baies vitrées, séjour cathédrale. Proche du CERN et des écoles internationales.',
    features: { 'Terrain': '500 m²', 'Piscine': 'Chauffée', 'Garage': 'Double', 'Domotique': 'Complète' },
    lat: 46.2340,
    lng: 6.0810,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '13',
    title: 'Attique lumineux à Nyon',
    price: 950000,
    charges_monthly: 420,
    address: 'Avenue Viollier 10',
    city: 'Nyon',
    canton: 'VD',
    postal_code: '1260',
    rooms: 4,
    ...
    description: 'Superbe attique de 4 pièces avec terrasse de 35 m² et vue lac. Dernière construction neuve à Nyon, finitions premium. Gare à 5 min, Genève en 15 min.',
    features: { 'Terrasse': '35 m²', 'Vue': 'Lac Léman', 'Parking': '2 places', 'État': 'Neuf' },
    lat: 46.3830,
    lng: 6.2390,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  ...
  {
    id: '14',
    title: '3 pièces meublé aux Eaux-Vives',
    price: 2450,
    charges_monthly: 200,
    address: 'Rue Sillem 8',
    city: 'Genève',
    canton: 'GE',
    postal_code: '1207',
    rooms: 3,
    ...
    description: 'Appartement meublé de 3 pièces au coeur des Eaux-Vives. Entièrement équipé, prêt à emménager. Idéal pour expatrié ou séjour de moyenne durée. Proche lac et commerces.',
    features: { 'Meublé': 'Oui, complet', 'Balcon': '4 m²', 'Buanderie': 'Commune', 'Durée min.': '12 mois' },
    lat: 46.2030,
    lng: 6.1640,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '15',
    title: 'Studio centre-ville Lausanne',
    price: 1350,
    charges_monthly: 120,
    ...
    description: 'Studio lumineux au centre de Lausanne, à deux pas de la gare et du Flon. Rénové récemment, cuisine équipée, salle de douche moderne. Idéal étudiant ou jeune professionnel.',
    features: { 'Rénové': '2024', 'Cuisine': 'Équipée', 'Charges': 'CHF 120/mois', 'Disponibilité': 'Immédiate' },
    lat: 46.5197,
    lng: 6.6323,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '16',
    title: '4.5 pièces familial à Lancy',
    price: 2800,
    charges_monthly: 250,
    address: 'Route de Chancy 112',
    city: 'Lancy',
    canton: 'GE',
    postal_code: '1213',
    rooms: 4.5,
    ...
    description: 'Grand appartement familial de 4.5 pièces à Lancy. Trois chambres, séjour spacieux, cuisine semi-ouverte. Balcon de 8 m², cave, parking souterrain inclus. Proche écoles et transports.',
    features: { 'Parking': 'Inclus', 'Balcon': '8 m²', 'Cave': 'Oui', 'École': 'À 200m' },
    lat: 46.1830,
    lng: 6.1180,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '17',
    title: 'Villa avec jardin à Vernier',
    price: 4500,
    charges_monthly: 0,
    address: 'Chemin des Bossons 18',
    city: 'Vernier',
    canton: 'GE',
    postal_code: '1214',
    rooms: 6,
    ...
    description: 'Belle villa familiale avec jardin de 400 m² à Vernier. Quatre chambres, double séjour, cuisine ouverte équipée. Garage double, terrasse couverte. Proche organisations internationales.',
    features: { 'Jardin': '400 m²', 'Garage': 'Double', 'Animaux': 'Acceptés', 'Disponibilité': '01.05.2026' },
    lat: 46.2170,
    lng: 6.0850,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '18',
    title: '2 pièces rénové Servette',
    price: 1680,
    charges_monthly: 150,
    address: 'Rue de la Servette 67',
    city: 'Genève',
    canton: 'GE',
    postal_code: '1202',
    rooms: 2,
    ...
    description: 'Appartement de 2 pièces entièrement rénové à la Servette. Cuisine neuve, salle de bains moderne, parquet. Proche des transports et commerces. Vue dégagée depuis le 5e étage.',
    features: { 'Rénové': '2025', 'Ascenseur': 'Oui', 'Buanderie': 'Commune', 'Vue': 'Dégagée' },
    lat: 46.2120,
    lng: 6.1340,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '19',
    title: '5 pièces standing Champel',
    price: 5500,
    charges_monthly: 350,
    address: 'Avenue de Miremont 30',
    city: 'Genève',
    canton: 'GE',
    postal_code: '1206',
    rooms: 5,
    ...
    description: 'Magnifique 5 pièces de standing dans un immeuble récent à Champel. Parquet chêne, grandes baies vitrées, balcon de 15 m². Deux places de parking, cave. Quartier calme et verdoyant.',
    features: { 'Parking': '2 places incluses', 'Balcon': '15 m²', 'Cave': 'Oui', 'Buanderie': 'Privée' },
    lat: 46.1920,
    lng: 6.1510,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '20',
    title: 'Appartement vue lac Montreux',
    price: 2200,
    charges_monthly: 180,
    address: 'Avenue Claude Nobs 5',
    city: 'Montreux',
    canton: 'VD',
    postal_code: '1820',
    rooms: 3,
    ...
    description: 'Bel appartement avec vue frontale sur le lac Léman et les Alpes. Résidence récente avec piscine commune. Proche de la gare et du centre-ville de Montreux.',
    features: { 'Vue': 'Lac et Alpes', 'Piscine': 'Commune', 'Parking': '1 place', 'Balcon': '12 m²' },
    lat: 46.4312,
    lng: 6.9107,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '21',
    title: 'Maison individuelle Nyon',
    price: 3800,
    charges_monthly: 0,
    address: 'Chemin des Plantaz 7',
    city: 'Nyon',
    canton: 'VD',
    postal_code: '1260',
    rooms: 5,
    ...
    description: 'Maison individuelle avec jardin à Nyon. Cinq pièces, trois chambres, double séjour avec cheminée. Jardin arboré de 300 m². Proche de la gare, Genève en 15 min en train.',
    features: { 'Jardin': '300 m²', 'Cheminée': 'Oui', 'Garage': 'Simple', 'Animaux': 'Acceptés' },
    lat: 46.3810,
    lng: 6.2350,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '22',
    title: '3.5 pièces lumineux Vevey',
    price: 1950,
    charges_monthly: 160,
    address: 'Rue du Simplon 14',
    city: 'Vevey',
    canton: 'VD',
    postal_code: '1800',
    rooms: 3.5,
    ...
    photos: [
      'https://images.unsplash.com/photo-1588854337236-6889d631faa8?w=1200&h=800&fit=crop',
      'https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=600&fit=crop',
    ],
    description: 'Joli 3.5 pièces lumineux à Vevey, quartier résidentiel calme. Vue partielle lac, balcon, cuisine ouverte équipée. Proche de la place du Marché et du quai.',
    features: { 'Vue': 'Partielle lac', 'Balcon': '6 m²', 'Parking': 'Extérieur', 'Buanderie': 'Commune' },
    lat: 46.4603,
    lng: 6.8431,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '23',
    title: 'Grand 4 pièces Plainpalais',
    price: 2650,
    charges_monthly: 200,
    address: 'Boulevard des Philosophes 18',
    city: 'Genève',
    canton: 'GE',
    postal_code: '1205',
    rooms: 4,
    ...
    description: 'Grand 4 pièces traversant en plein coeur de Plainpalais. Hauts plafonds, parquet d\'époque, moulures. Proche université, parc des Bastions, transports. Charme de l\'ancien avec confort moderne.',
    features: { 'Hauteur': '3.2 m', 'Parquet': 'Chêne d\'époque', 'Cave': 'Oui', 'Transports': 'Tram à 50m' },
    lat: 46.1990,
    lng: 6.1420,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '24',
    title: 'Attique avec terrasse Carouge',
    price: 3200,
    charges_monthly: 250,
    address: 'Rue Saint-Joseph 6',
    city: 'Carouge',
    canton: 'GE',
    postal_code: '1227',
    rooms: 4,
    ...
    description: 'Magnifique attique avec terrasse de 30 m² à Carouge. Dernier étage sans vis-à-vis, vue dégagée. Cuisine ouverte design, 2 chambres, buanderie privée. Le charme de Carouge en altitude.',
    features: { 'Terrasse': '30 m²', 'Vue': 'Dégagée', 'Buanderie': 'Privée', 'Parking': '1 place souterraine' },
    lat: 46.1840,
    lng: 6.1380,
    agent: { name: 'Sophie Martin', agency: 'MEGGA Immobilier', phone: '+41 22 700 56 78', email: 'sophie@megga.ch', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
  },
  {
    id: '25',
    title: 'Appartement neuf Cornavin',
    price: 495000,
    charges_monthly: 250,
    ...
    description: 'Appartement neuf de 3 pièces dans un immeuble Minergie à deux pas de la gare Cornavin. Finitions haut de gamme, cuisine Siemens, salle de bains italienne. Idéal premier achat.',
    features: { 'Minergie': 'Oui', 'Cuisine': 'Siemens intégrée', 'État': 'Neuf', 'Ascenseur': 'Oui' },
    lat: 46.2100,
    lng: 6.1430,
    agent: { name: 'Gregory Lyonnet', agency: 'MEGGA Immobilier', phone: '+41 22 700 12 34', email: 'gregory@megga.ch', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  },
