...
export function useCalendarScreen(): UseCalendarScreenReturn {
  ...
  const { data: visits = [], isLoading: visitsLoading, isError: visitsError, refetch: refetchVisits } = useQuery({
    queryKey: ['calendar-visits', agencyId, range.from, range.to],
  ...
  const { data: reminders = [], isLoading: remindersLoading, isError: remindersError, refetch: refetchReminders } = useQuery({
    queryKey: ['calendar-reminders', agencyId, range.from, range.to],
  ...
  const { data: appointments = [], isLoading: apptLoading, isError: apptError, refetch: refetchAppts } = useQuery({
    queryKey: ['calendar-appointments', agencyId, range.from, range.to],
  ...
  const { data: hotBuyerRows = [], isLoading: hotLoading, isError: hotError, refetch: refetchHot } = useQuery({
    queryKey: ['calendar-hot-buyers', agencyId],
