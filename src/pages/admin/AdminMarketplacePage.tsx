...
const STATUS_FILTERS = [
  ...
  { value: 'removed', label: 'Retires' },
]

const STATUS_CONFIG: Record<string, { label: string; dotColor: string }> = {
  published: { label: 'Publie', dotColor: 'bg-emerald-500' },
  flagged: { label: 'Signale', dotColor: 'bg-amber-500' },
  removed: { label: 'Retire', dotColor: 'bg-red-500' },
}
  ...
  return (
    <div className="px-4 py-16 text-center">
      ...
      <p className="text-sm text-theme-secondary font-medium">
        {hasFilters ? 'Aucun bien trouve' : 'Aucun bien a moderer'}
      </p>
      <p className="text-xs text-theme-tertiary mt-1">
        {hasFilters ? 'Modifiez vos filtres de recherche' : 'Les biens publies apparaitront ici'}
      </p>
    </div>
  )
}
  ...
  return (
    <PageTransition>
      <div className="max-w-5xl mx-auto space-y-5">
        ...
        <div className="md:hidden space-y-2">
          {isLoading ? (
            ...
            paginated.map((listing) => {
              const statusInfo = STATUS_CONFIG[listing.moderation_status] ?? STATUS_CONFIG.published
              return (
                <div
                  key={listing.id}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-theme-primary truncate">{listing.title || 'Sans titre'}</p>
        ...
        <div className="hidden md:block rounded-xl border border-theme-border">
          ...
          <div className="flex items-center px-4 py-2.5 border-b border-theme-border text-[11px] font-medium text-theme-tertiary uppercase tracking-wider">
            ...
            <span className="w-14 text-center">Canton</span>
      ...
      <ModerationActionDialog
        ...
        propertyTitle={dialogListing?.title || 'Sans titre'}
