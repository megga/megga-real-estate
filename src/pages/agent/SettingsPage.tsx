...
const PLANS: PlanConfig[] = [
  {
    ...
    features: [
      ...
      { textKey: 'subscription.features.staging', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { textKey: 'subscription.features.staging50', included: true },
      { textKey: 'subscription.features.prioritySupport', included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { textKey: 'subscription.features.staging200', included: true },
