...
export const DESINSCRIPTION_COPIE: Record<LangueDesinscription, CopieDesinscription> = {
  ...
  fr: {
    ...
    T16: "Écrivez-nous à privacy@getmegga.com et nous le ferons à la main.",
    T17: "Ce lien n'est plus valide.",
    T18: "Écrivez-nous à privacy@getmegga.com et nous vous désinscrirons à la main.",
  ...
  de: {
    ...
    T16: "Schreiben Sie uns an privacy@getmegga.com, und wir erledigen es von Hand.",
    T17: "Dieser Link ist nicht mehr gültig.",
    T18: "Schreiben Sie uns an privacy@getmegga.com, und wir melden Sie von Hand ab.",
  ...
  en: {
    ...
    T16: "Write to us at privacy@getmegga.com and we will do it manually.",
    T17: "This link is no longer valid.",
    T18: "Write to us at privacy@getmegga.com and we will unsubscribe you manually.",
  ...
  it: {
    ...
    T16: "Ci scriva a privacy@getmegga.com e provvederemo manualmente.",
    T17: "Questo link non è più valido.",
    T18: "Ci scriva a privacy@getmegga.com e La cancelleremo manualmente.",
