    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          {STEPS.map(step => (
            <div key={step.num} className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-gray-50 rounded-xl h-48 flex items-center justify-center text-gray-400 text-sm border border-gray-100">
                  Screenshot à venir
                </div>
                <Link to={step.link} className="inline-flex items-center gap-1 text-xs text-gray-500 hover:text-accent mt-2 transition-colors">
                  Lire le guide complet <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </div>
          ))}
        ...
        <div className="mt-12 text-center rounded-xl border border-gray-200 p-8">
          <p className="text-xl font-semibold text-gray-900 mb-2">Vous êtes prêt !</p>
          <p className="text-sm text-gray-500 mb-4">Besoin d'aide ? Demandez à MEGGA AI ou parcourez les guides.</p>
