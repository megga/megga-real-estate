...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[calc(100vh-72px)] flex items-end justify-center overflow-hidden">
        <img
          src="/hero-megga.jpg"
        ...
        <div className="relative z-10 w-full px-4 md:px-8 pb-14 md:pb-20 md:ml-[60px]">
          <HeroSearch />
        </div>
      </section>
