...
export function AtlEmptyCockpit() {
...
export interface AtlEmptyBodyProps {
...
export function AtlEmptyBody({ scan, onOpenContacts }: AtlEmptyBodyProps) {
  const { t } = useTranslation('matching')
  return (
    <>
