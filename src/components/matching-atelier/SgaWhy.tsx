...
function SgaVerifiedSeal({ size = 17, label }: { size?: number; label: string }) {
  return (
      ...
      <div className="sga-why-head">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            {verified && <SgaVerifiedSeal size={17} label={t('atelierKyc.verified')} />}
          </div>
        </div>
      </div>
