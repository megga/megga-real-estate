...
const UserDelete6 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 1.5, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M20.9664 9.39321L17.6251 12.6197M21.0003 12.6526L17.5918 9.36133" stroke="currentColor"></path>
...
UserDelete6.displayName = 'UserDelete6'

export default UserDelete6
