...
const DocumentLineChart = forwardRef<SVGSVGElement, Props>(
...
<path d="M8.57666 15.6794L10.7717 12.8123L13.2759 14.7883L15.4236 12.001" stroke="currentColor"></path>
    </svg>
  ),
)

DocumentLineChart.displayName = 'DocumentLineChart'

export default DocumentLineChart
