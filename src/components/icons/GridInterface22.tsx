...
const GridInterface22 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path fillRule="evenodd" clipRule="evenodd" d="M16.198 3H18.802C20.016 3 21 3.984 21 5.198V7.802C21 9.016 20.016 10 18.802 10H16.198C14.984 10 14 9.016 14 7.802V5.198C14 3.984 14.984 3 16.198 3Z" stroke="currentColor"></path>
...
GridInterface22.displayName = 'GridInterface22'

export default GridInterface22
