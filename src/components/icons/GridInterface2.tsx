...
const GridInterface2 = forwardRef<SVGSVGElement, Props>(
...
<path d="M11.0273 3V20.9995" stroke="currentColor"></path>
<path d="M21.0001 12H11.0273" stroke="currentColor"></path>
    </svg>
  ),
)

GridInterface2.displayName = 'GridInterface2'

export default GridInterface2
