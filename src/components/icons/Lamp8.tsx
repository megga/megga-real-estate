...
const Lamp8 = forwardRef<SVGSVGElement, Props>(
...
<path d="M9.32617 16.0703H14.692" stroke="currentColor"></path>
<path d="M13.0716 15.9236L14.2167 8.78125H9.73633L10.8815 15.9236" stroke="currentColor"></path>
    </svg>
  ),
)

Lamp8.displayName = 'Lamp8'

export default Lamp8
