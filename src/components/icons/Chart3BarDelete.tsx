...
const Chart3BarDelete = forwardRef<SVGSVGElement, Props>(
...
<path d="M21.5025 7L17.0025 2.5M17 7L21.5 2.5" stroke="currentColor"></path>
    </svg>
  ),
)

Chart3BarDelete.displayName = 'Chart3BarDelete'

export default Chart3BarDelete
