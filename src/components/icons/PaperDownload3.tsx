...
const PaperDownload3 = forwardRef<SVGSVGElement, Props>(
...
<path d="M11.6604 16.0172V9.9762" stroke="currentColor"></path>
<path d="M9.3147 13.6622L11.6597 16.0172L14.0047 13.6622" stroke="currentColor"></path>
    </svg>
  ),
)

PaperDownload3.displayName = 'PaperDownload3'

export default PaperDownload3
