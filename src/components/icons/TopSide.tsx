...
const TopSide = forwardRef<SVGSVGElement, Props>(
...
<path d="M14.6038 15.6479L12.0002 12.8438L9.39648 15.6479" stroke="currentColor"></path>
<path d="M21 8.54297H3" stroke="currentColor"></path>
    </svg>
  ),
)
