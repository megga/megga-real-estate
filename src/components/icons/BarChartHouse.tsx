...
const BarChartHouse = forwardRef<SVGSVGElement, Props>(
...
<path d="M8.43945 12.3174V17.2504M12.0311 15.2316V17.2496M15.5639 11.2627V17.2495" stroke="currentColor"></path>
    </svg>
  ),
)

BarChartHouse.displayName = 'BarChartHouse'

export default BarChartHouse
