...
const FlashCircleDisable2 = forwardRef<SVGSVGElement, Props>(
...
<path d="M5.67676 5.67578L9.9751 9.97412" stroke="currentColor"></path>
<path d="M18.2783 18.2764L14.084 14.082" stroke="currentColor"></path>
    </svg>
  ),
)

FlashCircleDisable2.displayName = 'FlashCircleDisable2'

export default FlashCircleDisable2
