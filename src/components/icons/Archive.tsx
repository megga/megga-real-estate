...
const Archive = forwardRef<SVGSVGElement, Props>(
...
<path d="M15 14L11.9982 17L9 14" stroke="currentColor"></path>
<path d="M11.998 17V10" stroke="currentColor"></path>
<path d="M20.9336 7H3.05859" stroke="currentColor"></path>
    </svg>
  ),
)
