...
const MenuOpenRight = forwardRef<SVGSVGElement, Props>(
...
<path d="M17 12.0018L14 9M17 12.0018L14 15M17 12.0018H9.07897" stroke="currentColor"></path>
<path d="M9 3.06641L9 20.9414" stroke="currentColor"></path>
    </svg>
  ),
)

MenuOpenRight.displayName = 'MenuOpenRight'

export default MenuOpenRight
