...
const CandleChart2Line3 = forwardRef<SVGSVGElement, Props>(
...
<path d="M21 12.0005L12 12.0005L3 12.0005" stroke="currentColor"></path>
    </svg>
  ),
)

CandleChart2Line3.displayName = 'CandleChart2Line3'

export default CandleChart2Line3
