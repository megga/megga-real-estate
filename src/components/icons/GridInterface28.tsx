...
const GridInterface28 = forwardRef<SVGSVGElement, Props>(
...
<path d="M20.9995 12H3" stroke="currentColor"></path>
    </svg>
  ),
)

GridInterface28.displayName = 'GridInterface28'

export default GridInterface28
