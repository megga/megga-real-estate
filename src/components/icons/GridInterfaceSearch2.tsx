...
const GridInterfaceSearch2 = forwardRef<SVGSVGElement, Props>(
...
<path d="M19.3132 8.31325C18.0982 9.52825 16.1272 9.52825 14.9112 8.31325C13.6962 7.09725 13.6962 5.12725 14.9112 3.91125C16.1272 2.69625 18.0982 2.69625 19.3132 3.91125C20.5292 5.12725 20.5292 7.09725 19.3132 8.31325ZM19.3132 8.31325L21 9.9995" stroke="currentColor"></path>
    </svg>
  ),
)

GridInterfaceSearch2.displayName = 'GridInterfaceSearch2'

export default GridInterfaceSearch2
