...
const BoltSquare = forwardRef<SVGSVGElement, Props>(
...
<path d="M11.9846 16L14.5716 12.0011H9.42871L12.013 8" stroke="currentColor"></path>
    </svg>
  ),
)

BoltSquare.displayName = 'BoltSquare'

export default BoltSquare
