...
const ShieldError = forwardRef<SVGSVGElement, Props>(
...
<path d="M12.001 16.066V15.9668" stroke="currentColor"></path>
<path d="M11.9971 9.14648V12.9401" stroke="currentColor"></path>
    </svg>
  ),
)
