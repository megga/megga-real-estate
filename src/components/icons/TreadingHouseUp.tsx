...
const TreadingHouseUp = forwardRef<SVGSVGElement, Props>(
...
<path d="M7.62451 15.9072L10.4299 12.2621L13.6299 14.7746L16.3751 11.2313" stroke="currentColor"></path>
    </svg>
  ),
)

TreadingHouseUp.displayName = 'TreadingHouseUp'

export default TreadingHouseUp
