...
const DatabaseUp = forwardRef<SVGSVGElement, Props>(
...
<path d="M14.3076 17.1802L17.1245 14.3633L19.9414 17.1802" stroke="currentColor"></path>
<path d="M17.1249 21.0214V14.3633" stroke="currentColor"></path>
    </svg>
  ),
)
