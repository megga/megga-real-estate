...
const Terminal = forwardRef<SVGSVGElement, Props>(
...
<path d="M12.7188 15.1914H16.023" stroke="currentColor"></path>
<path d="M7.97852 9.87109L10.3506 12.2432L7.97852 14.6153" stroke="currentColor"></path>
    </svg>
  ),
)
