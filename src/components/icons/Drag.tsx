...
const Drag = forwardRef<SVGSVGElement, Props>(
...
<path d="M5.5 4L4 5.5L5.5 7" stroke="currentColor"></path>
<path d="M19 5.5C19 6.32843 18.3284 7 17.5 7C16.6716 7 16 6.32843 16 5.5C16 4.67157 16.6716 4 17.5 4C18.3284 4 19 4.67157 19 5.5Z" stroke="currentColor"></path>
<path d="M12.5 5.5H16" stroke="currentColor"></path>
<path d="M4 5.5H9" stroke="currentColor"></path>
    </svg>
  ),
)
