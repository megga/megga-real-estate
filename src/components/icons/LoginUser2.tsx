...
const LoginUser2 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 1.5, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M16.3477 10.0346H21.0139M16.3477 10.0346L18.23 8.16016M16.3477 10.0346L18.23 11.908" stroke="currentColor"></path>
...
LoginUser2.displayName = 'LoginUser2'
