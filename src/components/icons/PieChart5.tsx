...
const PieChart5 = forwardRef<SVGSVGElement, Props>(
...
<path d="M11.6895 3.00439V11.3089C11.6895 11.8612 12.1372 12.3089 12.6895 12.3089H20.994" stroke="currentColor"></path>
    </svg>
  ),
)

PieChart5.displayName = 'PieChart5'
