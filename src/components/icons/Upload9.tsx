...
const Upload9 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M12.0005 4V16M12.0005 4L15 6.91774M12.0005 4L9 6.91774" stroke="currentColor"></path>
