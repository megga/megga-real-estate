...
const BottomSheetClose = forwardRef<SVGSVGElement, Props>(
...
<path d="M12.0003 21L15.5 17.5111M12.0003 21L8.5 17.5111M12.0003 21L12.0001 13" stroke="currentColor"></path>
    </svg>
  ),
)
