...
const ChartMagnifier = forwardRef<SVGSVGElement, Props>(
...
<path d="M8.36328 10.4475V14.1041M11.6605 8.13379V14.1042M14.9026 12.1997V14.1039" stroke="currentColor"></path>
    </svg>
  ),
)

ChartMagnifier.displayName = 'ChartMagnifier'
