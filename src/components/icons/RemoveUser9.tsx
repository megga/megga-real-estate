...
const RemoveUser9 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 1.5, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M20.9998 12.3164H16.9609" stroke="currentColor"></path>
...
RemoveUser9.displayName = 'RemoveUser9'

export default RemoveUser9
