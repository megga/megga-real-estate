...
const Download4 = forwardRef<SVGSVGElement, Props>(
...
<path d="M7.78125 11.2066L11.9997 15.5509M11.9997 15.5509L16.2182 11.2066M11.9997 15.5509L12.0002 3" stroke="currentColor"></path>
    </svg>
  ),
)

Download4.displayName = 'Download4'
