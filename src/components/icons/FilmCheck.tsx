...
const FilmCheck = forwardRef<SVGSVGElement, Props>(
...
<path d="M9.31445 13.9973L11.0698 15.7556L14.6858 12.1367" stroke="currentColor"></path>
<path d="M3.45703 7.47591H20.5428M9.02372 7.47563V3M14.9769 7.47563V3" stroke="currentColor"></path>
    </svg>
  ),
)

FilmCheck.displayName = 'FilmCheck'

export default FilmCheck
