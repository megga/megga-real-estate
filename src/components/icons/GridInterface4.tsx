...
const GridInterface4 = forwardRef<SVGSVGElement, Props>(
...
<path d="M9.13867 3V21" stroke="currentColor"></path>
    </svg>
  ),
)

GridInterface4.displayName = 'GridInterface4'

export default GridInterface4
