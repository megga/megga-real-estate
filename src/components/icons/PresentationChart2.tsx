...
const PresentationChart2 = forwardRef<SVGSVGElement, Props>(
  ({ size = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M12.0001 12.3371V7.02637M16.1442 12.3369V9.58752M7.85596 12.3372V8.79604" stroke="currentColor"></path>
...
PresentationChart2.displayName = 'PresentationChart2'

export default PresentationChart2
