...
const FlashCircleDisable = forwardRef<SVGSVGElement, Props>(
...
<path d="M18.2783 18.2793L13.5498 13.5508" stroke="currentColor"></path>
<path d="M5.70996 5.70996L9.76562 9.76562" stroke="currentColor"></path>
    </svg>
  ),
)

FlashCircleDisable.displayName = 'FlashCircleDisable'

export default FlashCircleDisable
