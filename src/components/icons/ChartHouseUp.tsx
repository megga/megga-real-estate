...
const ChartHouseUp = forwardRef<SVGSVGElement, Props>(
...
<path d="M12.6953 11.5007L14.9682 10.8877L15.5802 13.1606" stroke="currentColor"></path>
<path d="M14.9691 10.8877L12.3411 15.4559L9.93681 14.0733L8.42188 16.7071" stroke="currentColor"></path>
    </svg>
  ),
)

ChartHouseUp.displayName = 'ChartHouseUp'

export default ChartHouseUp
