...
import { IDENTITY_ADDRESS_LABELS, IDENTITY_COMPANY_LABELS, IDENTITY_FR_COMPANY_LABELS } from '../tokens'
                  ...
                  {(id) => (
                    estFrance ? (
                      ...
                      <MxFrenchCompanyField
                        ...
                        labels={IDENTITY_FR_COMPANY_LABELS}
                      />
                    ) : estSuisse ? (
                      <MxCompanySearch
                        id={id}
                        ...
                        labels={IDENTITY_COMPANY_LABELS}
                      />
                    ) : (
                ...
                {(id) => (
                  estFrance ? (
                    ...
                    <MxFrenchAddressField
                      ...
                      labels={IDENTITY_ADDRESS_LABELS}
                    />
                  ) : adresseSuisseOuLi ? (
