 ...
 */
function KypFicheOverlay({ sp, children }: { sp: CrmPalette; children: ReactNode }) {
  return (
    <div
      style={{
        position: 'absolute',
    ...
    >
      <div
        ...
        style={{
          ...
          background: surf.card,
          borderRadius: 'var(--crm-radius-5xl)',
          boxShadow: `0 40px 100px ${crmVoileEncre(false, 0.30)}, 0 8px 24px ${crmVoileEncre(false, 0.14)}`,
