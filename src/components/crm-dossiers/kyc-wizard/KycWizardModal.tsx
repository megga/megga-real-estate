...
import { DOSSIER_FONT } from '../tokens'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <KycCircleBtn
          icon={<CrmIcon name="close" size={18} stroke={sp.ink} />}
          onClick={onClose}
        ...
        >
          <div style={{ pointerEvents: 'auto' }}>
            {step > 0 && (
              <KycGhostPill
                onClick={prev}
                icon={<CrmIcon name="arrowL" size={16} stroke={sp.inkSoft} />}
              >
          ...
          <div style={{ pointerEvents: 'auto', display: 'flex', alignItems: 'center', gap: 'var(--crm-space-3xl)' }}>
            <KycBlackPill
              ...
              size="lg"
              icon={<CrmIcon name="arrowR" size={16} stroke={sp.onAccent} />}
            >
