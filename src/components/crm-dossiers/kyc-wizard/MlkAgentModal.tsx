...
//
// Direction artistique : MEGGA X, tokens dossierPalette(), l'élément ACTIF porte
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: selected
          ? `0 14px 32px ${crmVoileEncre(false, 0.20)}, 0 4px 12px ${crmVoileEncre(false, 0.10)}`
          : 'none',
        fontFamily: 'inherit',
        cursor: 'pointer',
        display: 'flex',
      ...
      >
        <span
          style={{
            padding: 'var(--crm-space-2xs) var(--crm-space-md)',
            borderRadius: 'var(--crm-radius-pill)',
            background: selected ? 'rgba(255,255,255,0.12)' : `${crmVoileEncre(false, 0.05)}`,
          }}
        >
          {duration}
        </span>
    ...
    >
      <div
        style={{
          ...
          boxShadow: selected ? 'none' : `inset 0 0 0 1.5px ${crmVoileEncre(false, 0.22)}`,
          display: 'grid',
          placeItems: 'center',
        }}
      >
        {selected && <CrmIcon name="check" size={11} stroke="#fff" sw={3} />}
      </div>
      <div
        style={{
          width: 32,
      ...
      >
        <CrmIcon name={icon} size={15} stroke={S.ink} sw={1.7} />
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        zIndex: 9100,
        background: `${crmVoileEncre(false, 0.45)}`,
        display: 'flex',
        alignItems: 'center',
  ...
  return (
    <>
      ...
      >
        ...
        >
          <CrmIcon name="close" size={16} stroke={S.inkSoft} sw={2} />
        </button>
      </div>
      ...
      <div style={{ padding: '0 32px 8px' }}>
        ...
        >
          <CrmIcon name="clock" size={14} stroke={S.muted} sw={1.8} />
          <span
            style={{
      ...
      >
        ...
        <KycBlackPill
          ...
          icon={<CrmIcon name="arrowR" size={16} stroke="#fff" sw={2} />}
        >
          {isPending
  ...
  return (
    <>
      <div style={{ padding: '40px 40px 24px', textAlign: 'center' }}>
        ...
        >
          <CrmIcon name="check" size={32} stroke={S.okDark} sw={2.5} />
        </div>
        <div
          style={{
            fontSize: 'var(--crm-text-xs)',
