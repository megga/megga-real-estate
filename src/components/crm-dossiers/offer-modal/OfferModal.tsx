...
import { CrmIcon, type CrmIconName } from '@/components/crm-dossiers/icons'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CrmIcon name={icon} size={18} stroke={active ? pal.accentInk : pal.inkSoft} sw={1.8} />
        </div>
        ...
        >
          {active && <CrmIcon name="check" size={13} stroke={pal.accentInk} sw={3} />}
        </div>
      </div>
...
export default function OfferModal({
  ...
  const pal = omPalette(dark, crmPalette(dark))
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CrmIcon name="close" size={18} stroke={pal.inkSoft} />
        </button>
      </header>
            ...
            >
              {parentOffer && (
                ...
                >
                  ...
                  >
                    <CrmIcon name="swap" size={17} stroke={pal.inkSoft} sw={2.2} />
                  </div>
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
