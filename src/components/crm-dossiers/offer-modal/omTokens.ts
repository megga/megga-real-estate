 ...
 * (`OM_LIGHT` / `OM_DARK`) recopiées de l'échelle grise de DossierTokens, dont le noir
 ...
 *
 * ⚠ Cette modale n'importe RIEN de `DossierTokens` : ni jeton, ni palette. Le plan la
 * rangeait sous « recibler DossierTokens » ; elle portait en fait son propre système.
 *
