        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              autoFocus
              className="w-full h-11 px-4 text-sm bg-transparent border border-theme-border rounded-lg text-theme-primary placeholder:text-theme-tertiary focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent text-center"
            />
            {error && (
