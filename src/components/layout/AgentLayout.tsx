      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden h-14 bg-white border-b border-border flex items-center px-4 sticky top-0 z-30">
          <button
            ...
            className="p-2 -ml-2 rounded-md hover:bg-section"
          >
            <Menu className="h-5 w-5 text-primary-700" />
          </button>
          <div className="ml-3 flex items-center gap-2">
            <div className="h-6 w-6 bg-primary-900 rounded flex items-center justify-center">
