  ...
  return (
    <div
      style={{
        ...
        gap: 22,
        // Note : l'animation d'entrée est maintenant gérée par AnimatePresence
        // dans le shell (motion.div parent). On garde uniquement la transition
        // pour le switch light/dark.
        transition: 'var(--bento-tx)',
      }}
    >
