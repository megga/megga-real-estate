  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto',
      ...
      <div style={{ marginBottom: 28, maxWidth: 720 }}>
        ...
        {linkedOwner && (
          <div style={{
            ...
            <span style={{ fontSize: 'var(--crm-text-sm)', fontWeight: 500, color: WizardTokens.muted }}>
      ...
      <>
              ...
              return (
                <button key={t.v} onClick={() => choose(t.v)}
                  style={{
                    ...
                    background: sel ? WizardTokens.black : WizardTokens.card,
                    color: sel ? crmOn() : WizardTokens.ink,
                  ...
                  {t.hint && (
                    <span style={{
                      ...
                      background: sel ? crmAcc(0.15) : WizardTokens.cardSubtle,
                  ...
                  <p style={{
                    ...
                    color: sel ? crmAcc(0.75) : WizardTokens.inkSoft,
                  }}>{t.sub}</p>
                  <div style={{
                    marginTop: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                    fontSize: 'var(--crm-text-md)', fontWeight: 600,
                    color: sel ? crmAcc(0.6) : WizardTokens.muted,
                  }}>
                    <span>{tr('wizard.step1.mandate.proposedCommission')}</span>
                    <span style={{ fontSize: 'var(--crm-text-xl)', fontWeight: 600, color: sel ? crmOn() : WizardTokens.ink }}>{t.defaultCom}%</span>
                  </div>
                </button>
              )
            })}
          ...
          {m.type && (
            <div style={{
              background: WizardTokens.card, borderRadius: 'var(--crm-radius-5xl)', padding: 28,
              ...
              <div style={{ marginBottom: 22 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 'var(--crm-text-3xl)', fontWeight: 600, color: WizardTokens.ink, letterSpacing: -0.3 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr', gap: 'var(--crm-space-6xl)' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--crm-space-md)' }}>
                    {[3, 6, 9, 12].map(d => (
                      <button key={d} onClick={() => setM({ duration: d })} style={{
                        ...
                        background: m.duration === d ? WizardTokens.black : WizardTokens.cardSubtle,
                        color: m.duration === d ? crmOn() : WizardTokens.inkSoft,
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 12 }}>
                    ...
                    <span style={{ fontSize: 'var(--crm-text-2xl)', fontWeight: 600, color: WizardTokens.ink, letterSpacing: -0.3 }}>
                  ...
                  <input type="range" min="2" max="6" step="0.1" value={m.commission}
                    ...
                    style={{
                      ...
                      background: `linear-gradient(to right, ${WizardTokens.black} 0%, ${WizardTokens.black} ${((m.commission - 2) / 4) * 100}%, ${WizardTokens.cardSubtle} ${((m.commission - 2) / 4) * 100}%, ${WizardTokens.cardSubtle} 100%)`,
                      outline: 'none',
                    }} />
                </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--crm-space-sm)' }}>
                    {[
                      ...
                      <button key={o.v} onClick={() => setM({ fees: o.v })} style={{
                        ...
                        background: m.fees === o.v ? WizardTokens.black : WizardTokens.cardSubtle,
                        color: m.fees === o.v ? crmOn() : WizardTokens.inkSoft,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: WizardTokens.card,
                  display: 'grid', placeItems: 'center',
                  boxShadow: WizardTokens.shadowSm,
                }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={WizardTokens.ink} strokeWidth="1.8" strokeLinecap="round">
                    <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7H14a3.5 3.5 0 0 1 0 7H6"/>
                  </svg>
                </div>
                <div style={{ fontSize: 'var(--crm-text-lg)', color: WizardTokens.inkSoft, fontWeight: 500, lineHeight: 1.5 }}>
                  <Trans
                    t={tr}
                    ...
                    components={{
                      base: <span style={{ color: WizardTokens.ink, fontWeight: 600 }} />,
                      amountStrong: <span style={{ color: WizardTokens.ink, fontWeight: 600 }} />,
                    }}
                  />
                </div>
              </div>
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  background: m.signed ? WizardTokens.ok : WizardTokens.warn,
                }} />
                <span style={{ fontSize: 'var(--crm-text-md)', fontWeight: 500, color: WizardTokens.inkSoft, flex: 1 }}>
                  {m.signed
                ...
                <button onClick={() => setM({ signed: !m.signed })} style={{
                  ...
                  background: m.signed ? WizardTokens.cardSubtle : WizardTokens.black,
                  color: m.signed ? WizardTokens.inkSoft : crmOn(),
                  fontFamily: 'inherit', fontSize: 'var(--crm-text-md)', fontWeight: 600, cursor: 'pointer',
                }}>
