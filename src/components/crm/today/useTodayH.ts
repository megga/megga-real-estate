...
export function useTodayH(): UseTodayHReturn {
  ...
  const { events, isLoading: calLoading, isError: calError, refetch: refetchCal } = useCalendarScreen()
  const { deals, isLoading: pipeLoading } = usePipelineScreen()
