...
const TK_LIGHT: Omit<Tk, 'mode'> = {
  ...
  shadow: `0 1px 2px ${crmVoileEncre(false, 0.05)}, 0 14px 36px -18px ${crmVoileEncre(false, 0.18)}`,
  shadowLg: `0 30px 70px -24px ${crmVoileEncre(false, 0.30)}, 0 8px 22px -14px ${crmVoileEncre(false, 0.16)}`,
