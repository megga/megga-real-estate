 ...
 * Port du handoff crm-screen-pipeline-sugar.jsx §CardQuickActions :
      ...
      <div style={{ position: 'relative' }}>
        ...
        {menuOpen && !reassignOpen && (
          <div style={panelStyle}>
            ...
            <ActionMenuItem sp={sp} dark={dark} icon="file" label={t('board.card.archive')}
...
function AgentMenuItem({ sp, member, onClick }: {
  sp: CrmPalette
...
function ActionMenuItem({ sp, icon, label, tone, onClick, dark, chevron }: {
  sp: CrmPalette
  icon: MEIconName
  label: string
  tone?: 'danger'
