 ...
 * texte blanc (crmStagePillBg) · valeur compacte CHF X.XXM/nK · prochaine
 * action + échéance en majuscules). Clic ligne → fiche deal.
 */

import { useTranslation } from 'react-i18next'
import { CRM_STAGES, crmInitials, crmStagePillBg, type CrmPalette } from '../tokens'
  ...
  return (
    <div style={{
      ...
      {deals.map((deal, i) => {
        ...
        const hue = crmStagePillBg(deal.stage, dark)
        ...
        return (
          ...
          onMouseLeave={e => { e.currentTarget.style.background = 'transparent' }}>
            ...
            <span style={{
              ...
              // ⛔ L'aplat vient de l'ÉTAPE du deal, donc de la donnée. `crmStagePillBg`
