...
import { WhatsAppGlyph, GgMonogram } from '@/components/crm/contacts-pager/glyphs'
...
function Benefit({ icon, sp, children }: { icon: NcvIconName; sp: CrmPalette; children: string }) {
  return (
