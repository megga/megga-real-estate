 ...
 * page réelle (AgentLayout ne rend NI sidebar NI header, les pages portent
 * CrmTopNav + CrmIconRail), et la couleur venait de `--color-bg-page`
 ...
 *   2. la géométrie décalque le chrome réel (CrmShell.tsx / LiquidGlassRail.tsx),
...
export default function CrmPageSkeleton() {
  ...
  return (
    ...
    >
      {/* Gabarit CrmTopNav — CrmShell.tsx (padding + gap identiques). L'inset
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        {/* Gabarit CrmIconRail — aside 128 px, capsule r34 (LiquidGlassRail.tsx:361-377). */}
        <aside
          style={{
            width: 128,
            flexShrink: 0,
